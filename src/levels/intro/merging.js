      ...
      "childViews": [
        ...
        },
        {
          ...
          "options": {
            ...
            "afterMarkdowns": [
              "Youhou ! Vous avez vu ça ? Tout d'abord, `main` pointe désormais sur un commit qui a deux parents. Si vous remontez l'enchaînement des flèches depuis `main`, vous allez passez par tous les commits jusqu'à la racine. Cela signifie que `main` contient maintenant tout le travail du dépôt.",
              "",
