      ...
      "childViews": [
        {
          ...
          "options": {
            "markdowns": [
              "### L'opérateur \"~\"",
              "",
              "Disons que vous souhaitez remonter beaucoup de niveaux dans l'arbre des commits. Cela peut être ennuyeux d'utiliser `^` plusieurs fois, c'est pourquoi Git a aussi l'opérateur tilde (~).",
              "",
              "",
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              ...
              "",
              "L'une des principales raisons pour lesquelles je me sers des références relatives est de me permettre de réorganiser les branches. Vous pouvez directement réassigner les branches à un commit avec l'option `-f`. Ainsi quelque chose comme :",
              "",
              "`git branch -f main HEAD~3`",
              "",
