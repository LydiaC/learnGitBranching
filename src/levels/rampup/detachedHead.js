      ...
      "childViews": [
        {
          ...
          "options": {
            "markdowns": [
              ...
              "",
              "Une fois que vous serez à l'aise avec ces déplacements, votre puissance avec les autres commandes de Git sera amplifiée !",
              "",
              "",
              "",
              "",
        ...
        },
        {
          ...
          "options": {
            ...
            "afterMarkdowns": [
              "Vous voyez ! HEAD était caché en dessous de la branche `main` depuis le début."
            ],
            "command": "git checkout C1; git checkout main; git commit; git checkout C2",
            "beforeCommand": ""
          }
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              "Pour terminer ce niveau, détachez HEAD de `bugFix` et attachez-le plutôt au commit.",
              "",
